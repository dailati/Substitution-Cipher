Substitution Cipher is a method of encrypting in which units of plaintext are replaced with the ciphertext and the aid of a key (in this code, in form of letters).
